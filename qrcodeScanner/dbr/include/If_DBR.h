...
DBR_API int DBR_DecodeStreamRect(unsigned char* pFileStream,
								int iFileSize,
								const pReaderOptions pOptions,
								int iRectLeft,
								int iRectTop,
...
DBR_API int DBR_DecodeBase64String(unsigned char* pFileStream,
								const pReaderOptions pOptions,
								pBarcodeResultArray* ppResults);

DBR_API int DBR_DecodeBase64StringRect(unsigned char* pFileStream,
								const pReaderOptions pOptions,
								int iRectLeft,
								int iRectTop,
								int iRectWidth,
